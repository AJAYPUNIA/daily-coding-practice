...
# only alphanumeric characters and dashes. The string is separated into n + 1 
...
# Output: "5F3Z-2E9W"
# Explanation: The string s has been split keinto two parts, each part has 4 characters.
